...
function DateRangePicker({
  ...
  return (
    <Calendar
      ...
      classNames={{
        day_range_start:
          "day-range-start bg-amber-500 text-white hover:bg-amber-500 hover:text-white focus:bg-amber-500 focus:text-white",
        day_range_end:
          "day-range-end bg-amber-500 text-white hover:bg-amber-500 hover:text-white focus:bg-amber-500 focus:text-white",
        day_selected:
          "bg-amber-500 text-white hover:bg-amber-500 hover:text-white focus:bg-amber-500 focus:text-white",
        day_range_middle:
          "aria-selected:bg-amber-100 aria-selected:text-amber-800",
